...
const SlideContainer = () => {
    ...
    return (
        <div className="min-h-screen w-full flex items-center justify-center bg-quest-dark p-0 md:p-8">
            ...
            <div className="relative w-full md:max-w-6xl aspect-auto md:aspect-[16/10] h-screen md:h-auto md:max-h-[90vh] bg-quest-card md:rounded-2xl shadow-2xl overflow-hidden border-0 md:border border-quest-primary/10">
                ...
                {/* Navigation Controls Overlay (Moved inside the frame) */}
                <div className="absolute bottom-6 right-6 flex gap-3 z-[100]">
                    ...
                    >
                        <span className="material-symbols-outlined font-bold hover:translate-x-1 transition-transform">arrow_forward</span>
                    </button>
                </div>

                {/* Progress Bar (Moved inside the frame) */}
