                ...
                <div className="boardouter">
                    <div className="BoardInfo">
                        ...
                        <p className="ml-auto">
                            ...
                            Current Position: <strong className="text-white">{position}</strong>
                        </p>
                    </div>
                        ...
                        <div className="space-y-4">
                            {!showQuestion ? (
                                ...
                                <div className="question-box">
                                    ...
                                    <h3 className="text-lg md:text-xl font-bold text-white">{currentQ.text}</h3>
                                    <div className="space-y-3 pt-2">
                                        {currentQ.options.map((opt, i) => (
                                            ...
                                            >
                                                ...
                                                <span className="text-white group-hover:text-quest-primary transition-colors">{opt}</span>
                                            </button>
                                        ))}
                                    </div>
                                </div>
